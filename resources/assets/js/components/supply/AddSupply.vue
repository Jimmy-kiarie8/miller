<template>
  <v-layout row justify-center>
    <v-dialog v-model="openAddRequest" persistent max-width="900px">
      <v-card>
        <v-card-title fixed>
          <span class="headline">Add Supply</span>
        </v-card-title>
        <v-card-text>
                ...
                <v-container grid-list-xl fluid>
                  <v-layout wrap>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="col-md-6">
                          <select class="custom-select" v-model="form.buyers">
...
export default {
  ...
  methods: {
    save() {
      this.loading=true
      axios.post('/supply', this.$data.form).
      then((response) => {
        this.loading=false
        ...
        this.$parent.AllSupply.push(response.data) 

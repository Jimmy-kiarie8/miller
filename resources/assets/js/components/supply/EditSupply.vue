          ...
          <v-container grid-list-xl fluid>
            <v-layout wrap>
              ...
              <div class="form-group  col-md-6">
                ...
                <div class="col-md-6">
                    <select class="custom-select" v-model="editedItemCon.buyers">
...
<script>
export default {
  props: ['editedItemCon', 'openEditRequest', 'buyers', 'coffeeType', 'units'],
  data() {
    return{
      loader: false,
      loading:false,
  ...
  methods: {
    update() {
      this.loading=true
      axios.patch(`/supply/${this.editedItemCon.id}`, this.editedItemCon)
      .then((response) => {
        // console.log(response);
        this.loading=false
        this.close;
            // this.resetForm();
            Object.assign(this.$parent.AllSupply[this.$parent.editedIndex], this.$parent.editedItem)

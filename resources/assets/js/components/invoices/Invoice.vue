...
<div>
					...
					<tbody>
						<tr v-for="invoice, key in invoices" :key="invoice.id">
							...
							<td>
								...
								<v-btn @click="invoiceShow(invoice.id)" flat color="info">View</v-btn>
	...
	<!-- <ShowInvoice @closeRequest="close" :openAddRequest="dispShow" @alertRequest="showAlert"></ShowInvoice> -->
</div>
</template>
